...
#include <memory>
#include "../../My_PCLogo/signinwidget.h"
...
QT_MOC_LITERAL(1, 12, 14), // "DialogResponse"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "User*"
QT_MOC_LITERAL(4, 34, 12), // "loginClicked"
QT_MOC_LITERAL(5, 47, 11), // "quitClicked"
QT_MOC_LITERAL(6, 59, 13) // "signupClicked"

    },
    "LoginDialog\0DialogResponse\0\0User*\0"
    "loginClicked\0quitClicked\0signupClicked"
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DialogResponse((*reinterpret_cast< User*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (LoginDialog::*)(User * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginDialog::DialogResponse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::DialogResponse(User * _t1)
{
