...
// This module implements the QsciLexerLogo class.
//
...
// The ctor.
QsciLexerLogo::QsciLexerLogo(QObject *parent, bool caseInsensitiveKeywords)
    : QsciLexer(parent),
...
// The dtor.
QsciLexerLogo::~QsciLexerLogo()
{
}


// Returns the language name.
const char *QsciLexerLogo::language() const
{
    return "C++";
}
...
const char *QsciLexerLogo::lexer() const
{
...
// words.
QStringList QsciLexerLogo::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *QsciLexerLogo::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *QsciLexerLogo::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *QsciLexerLogo::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int QsciLexerLogo::braceStyle() const
{
    return Operator;
}
...
const char *QsciLexerLogo::wordCharacters() const
{
...
QColor QsciLexerLogo::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerLogo::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont QsciLexerLogo::defaultFont(int style) const
{
    QFont f;
...
const char *QsciLexerLogo::keywords(int set) const
{
    if (set == 1)
        return
...
QString QsciLexerLogo::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor QsciLexerLogo::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void QsciLexerLogo::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool QsciLexerLogo::readProperties(QSettings &qs,const QString &prefix)
{
...
bool QsciLexerLogo::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void QsciLexerLogo::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void QsciLexerLogo::setAtElseProp()
{
...
void QsciLexerLogo::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void QsciLexerLogo::setCommentProp()
{
...
void QsciLexerLogo::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void QsciLexerLogo::setCompactProp()
{
...
void QsciLexerLogo::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void QsciLexerLogo::setPreprocProp()
{
...
void QsciLexerLogo::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void QsciLexerLogo::setStylePreprocProp()
{
...
void QsciLexerLogo::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void QsciLexerLogo::setDollarsProp()
{
...
void QsciLexerLogo::setHighlightTripleQuotedStrings(bool enabled)
{
...
void QsciLexerLogo::setHighlightTripleProp()
{
...
void QsciLexerLogo::setHighlightHashQuotedStrings(bool enabled)
{
...
void QsciLexerLogo::setHighlightHashProp()
{
...
void QsciLexerLogo::setHighlightBackQuotedStrings(bool enabled)
{
...
void QsciLexerLogo::setHighlightBackProp()
{
...
void QsciLexerLogo::setHighlightEscapeSequences(bool enabled)
{
...
void QsciLexerLogo::setHighlightEscapeProp()
{
...
void QsciLexerLogo::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
    vs_escape = allowed;
...
void QsciLexerLogo::setVerbatimStringEscapeProp()
{
