#ifndef QSCILEXERLOGO_H
#define QSCILEXERLOGO_H
...
class QsciLexerLogo : public QsciLexer {
  ...
  public:
    ...
    //! Construct a QsciLexerLogo with parent \a parent.  \a parent is typically
    //! the QsciScintilla instance.  \a caseInsensitiveKeywords is true if the
    //! lexer ignores the case of keywords.
    QsciLexerLogo(QObject *parent = 0, bool caseInsensitiveKeywords = false);

    //! Destroys the QsciLexerLogo instance.
    virtual ~QsciLexerLogo();
  ...
  private:
    ...
    QsciLexerLogo(const QsciLexerLogo &);
    QsciLexerLogo &operator=(const QsciLexerLogo &);
};

#endif // QSCILEXERLOGO_H
